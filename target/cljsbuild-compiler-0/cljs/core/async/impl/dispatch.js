...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_10075 = 0;while(true){
var m_10076 = cljs.core.async.impl.dispatch.tasks.pop();if((m_10076 == null))
{} else
{m_10076.call(null);
if((count_10075 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__10077 = (count_10075 + 1);
count_10075 = G__10077;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3941__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(cljs.core.truth_(and__3941__auto__))
