...
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t10081 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t10081');

/**
* @constructor
*/
cljs.core.async.impl.channels.t10081 = (function (val,box,meta10082){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t10081.cljs$lang$type = true;
cljs.core.async.impl.channels.t10081.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t10081";
cljs.core.async.impl.channels.t10081.cljs$lang$ctorPrWriter = (function (this__3369__auto__,writer__3370__auto__,opt__3371__auto__){return cljs.core._write.call(null,writer__3370__auto__,"cljs.core.async.impl.channels/t10081");
});
cljs.core.async.impl.channels.t10081.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t10081.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10083){var self__ = this;
return self__.meta10082;
});
cljs.core.async.impl.channels.t10081.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10083,meta10082__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t10081(self__.val,self__.box,meta10082__$1));
});
cljs.core.async.impl.channels.__GT_t10081 = (function __GT_t10081(val__$1,box__$1,meta10082){return (new cljs.core.async.impl.channels.t10081(val__$1,box__$1,meta10082));
});
}
return (new cljs.core.async.impl.channels.t10081(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3372__auto__,writer__3373__auto__,opts__3374__auto__){return cljs.core._write.call(null,writer__3373__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3369__auto__,writer__3370__auto__,opt__3371__auto__){return cljs.core._write.call(null,writer__3370__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_10084 = self__.takes.pop();if((taker_10084 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_10084))
{var take_cb_10085 = cljs.core.async.impl.protocols.commit.call(null,taker_10084);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_10085,taker_10084){
return (function (){return take_cb_10085.call(null,null);
});})(take_cb_10085,taker_10084))
);
} else
{}
{
...
{if((function (){var and__3941__auto__ = !((self__.buf == null));if(and__3941__auto__)
...
var closed__$1 = self__.closed;if((function (){var or__3943__auto__ = closed__$1;if(or__3943__auto__)
...
{if(!((function (){var or__3943__auto__ = (self__.buf == null);if(or__3943__auto__)
{return or__3943__auto__;
} else
