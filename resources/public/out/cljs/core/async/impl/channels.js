...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15385 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t15385');

/**
* @constructor
*/
cljs.core.async.impl.channels.t15385 = (function (val,box,meta15386){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15385.cljs$lang$type = true;
cljs.core.async.impl.channels.t15385.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15385";
cljs.core.async.impl.channels.t15385.cljs$lang$ctorPrWriter = (function (this__3491__auto__,writer__3492__auto__,opt__3493__auto__){return cljs.core._write.call(null,writer__3492__auto__,"cljs.core.async.impl.channels/t15385");
});
cljs.core.async.impl.channels.t15385.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15385.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15387){var self__ = this;
var _15387__$1 = this;return self__.meta15386;
});
cljs.core.async.impl.channels.t15385.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15387,meta15386__$1){var self__ = this;
var _15387__$1 = this;return (new cljs.core.async.impl.channels.t15385(self__.val,self__.box,meta15386__$1));
});
cljs.core.async.impl.channels.__GT_t15385 = (function __GT_t15385(val__$1,box__$1,meta15386){return (new cljs.core.async.impl.channels.t15385(val__$1,box__$1,meta15386));
});
}
return (new cljs.core.async.impl.channels.t15385(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3494__auto__,writer__3495__auto__,opts__3496__auto__){return cljs.core._write.call(null,writer__3495__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3491__auto__,writer__3492__auto__,opt__3493__auto__){return cljs.core._write.call(null,writer__3492__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_15388 = self__.takes.pop();if((taker_15388 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15388))
{var take_cb_15389 = cljs.core.async.impl.protocols.commit.call(null,taker_15388);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15389,taker_15388){
return (function (){return take_cb_15389.call(null,null);
});})(take_cb_15389,taker_15388))
);
} else
{}
{
