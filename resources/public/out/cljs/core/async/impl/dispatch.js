...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15379 = 0;while(true){
var m_15380 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15380 == null))
{} else
{m_15380.call(null);
if((count_15379 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15381 = (count_15379 + 1);
count_15379 = G__15381;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__2946__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__2946__auto__)
