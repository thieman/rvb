...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3491__auto__,writer__3492__auto__,opt__3493__auto__){return cljs.core._write.call(null,writer__3492__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var coll__$1 = this;return cljs.core.list.call(null,self__.key,self__.val);
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15356 = 0;while(true){
if((i_15356 < arr.length))
{(arr[i_15356] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3491__auto__,writer__3492__auto__,opt__3493__auto__){return cljs.core._write.call(null,writer__3492__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_15363 = (self__.level + 1);while(true){
if((i_15363 <= (new_level + 1)))
{(update[i_15363] = self__.header);
{
var G__15364 = (i_15363 + 1);
i_15363 = G__15364;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15365 = 0;while(true){
if((i_15365 <= self__.level))
{var links_15366 = (update[i_15365]).forward;if(((links_15366[i_15365]) === x__$1))
{(links_15366[i_15365] = (x__$1.forward[i_15365]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__2955__auto__ = (cljs.core.truth_((function (){var and__2946__auto__ = me;if(cljs.core.truth_(and__2946__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__2946__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__2955__auto__))
